...
public class HealthCheckupRequestDto {
    ...
    // 기본 생성자
    public HealthCheckupRequestDto() {}
    
    // 전체 매개변수 생성자
    public HealthCheckupRequestDto(String cxId, String privateAuthType, String reqTxId, String token, String txId, String userName, String birthDate, String userCellphoneNumber) {
        this.cxId = cxId;
